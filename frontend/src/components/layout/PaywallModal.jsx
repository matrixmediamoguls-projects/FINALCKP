    ...
    >
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ padding: '24px 28px 20px', borderBottom: '1px solid var(--border)', textAlign: 'center' }}>
          <div style={{ fontFamily: "'Oxanium',serif", fontSize: 24, fontWeight: 600, color: 'var(--white)', marginBottom: 8, letterSpacing: '0.06em' }}>
            Unlock Full System Access
          </div>
          <div style={{ fontFamily: "'Oxanium',serif", fontStyle: 'italic', fontSize: 15, color: 'var(--muted)', lineHeight: 1.55 }}>
            Choose your path to unlock Acts III & beyond
          </div>
          <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 8, letterSpacing: '0.3em', color: 'var(--muted)', marginTop: 4, textTransform: 'uppercase' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 3, padding: 16 }}>
          ...
          <div style={{
            ...
            <div style={{ fontFamily: "'Oxanium',serif", fontSize: 13, fontWeight: 600, color: 'var(--white)', marginBottom: 5, letterSpacing: '0.08em', marginTop: 8 }}>
              Protocol License
            </div>
            <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 18, color: 'var(--act)', marginBottom: 8 }}>
              $29.99
            </div>
          ...
          <div style={{
            ...
            <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 14, color: 'var(--gold)', marginBottom: 8 }}>
              Included with Album
            </div>
            <ul style={{ fontSize: 11, color: 'var(--muted)', lineHeight: 1.9, textAlign: 'left', listStyle: 'none' }}>
        ...
        <div style={{ padding: '0 16px 16px' }}>
          <button
            ...
            disabled={purchasing}
            style={{
              width: '100%', fontFamily: "'JetBrains Mono',monospace", fontSize: 9, letterSpacing: '0.4em',
        ...
        <div style={{ padding: '0 16px 16px', borderTop: '1px solid var(--border)', paddingTop: 16 }}>
          <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 7, letterSpacing: '0.3em', textTransform: 'uppercase', color: 'var(--muted)', marginBottom: 8 }}>
          ...
          <div style={{ display: 'flex', gap: 4 }}>
            <input
              ...
              style={{
                ...
                padding: '7px 10px', fontFamily: "'JetBrains Mono',monospace", fontSize: 10,
          ...
          {licenseError && (
            <div data-testid="license-error" style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 9, color: 'var(--r3)', marginTop: 6, letterSpacing: '0.1em' }}>
              {licenseError}
            </div>
          )}
        </div>
