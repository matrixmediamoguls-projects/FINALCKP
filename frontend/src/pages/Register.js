        ...
        <div className="auth-panel flex flex-col bg-[#030303]">
          <div className="flex flex-1 justify-center px-6 py-12 sm:px-10 lg:px-12">
            <motion.div
              ...
              className="auth-card relative z-10 flex w-full max-w-[372px] flex-col gap-7"
            >
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <button
                  ...
                  disabled={isPending}
                  className="auth-submit mt-2 flex h-12 w-full items-center justify-center bg-[#7ab829] text-sm font-bold uppercase tracking-[0.12em] text-black transition-all duration-200 hover:bg-[#8dd338] disabled:cursor-not-allowed disabled:opacity-60"
                >
