update public.reclamation_university
set
  lesson_body = $$Welcome, Rising Seeker. Module 1: The Fire Door.
...
Your work in this module is to cross the Fire Door. To cross it, name the restriction, retrieve the authorship, and speak the first law of the self that cannot be erased.$$,
  summary = 'Welcome, Rising Seeker. Module 1: The Fire Door.',
  updated_at = now()
where lesson_title = 'Module 1: The Fire Door';
